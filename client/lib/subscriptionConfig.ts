 ...
 *
 * Deferred 6–12 months: keep SUBSCRIPTIONS_ENABLED=false for free-tier acquisition.
 * Monetization P1 is Google AdMob only (see admobConfig.ts).
 *
...
/** Master switch. False by default — do not enable until subscriptions ship. */
export const SUBSCRIPTIONS_DEFERRED = true;

/** Master switch — forced off while SUBSCRIPTIONS_DEFERRED is true. */
export const SUBSCRIPTIONS_ENABLED = SUBSCRIPTIONS_DEFERRED
  ? false
  : envBool("VITE_SUBSCRIPTIONS_ENABLED", "EXPO_PUBLIC_SUBSCRIPTIONS_ENABLED");
